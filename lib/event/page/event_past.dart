...
class PastEvent extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _PastEvent();
}

class _PastEvent extends State<PastEvent> {
        ...
        builder: (context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data.length == 0) {
              return Center(child: const Text("Belum ada Event yang Telah Berakhir"));
            }
